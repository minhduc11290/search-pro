...
function StoreList() {
  ...
  const toggleSelectAll = () => {
    ...
    if (selectAllValue) {
      setSelectedProducts(dataDisplay.map((store: Store) => store.id));
    } else {
      setSelectedProducts([]);
    }
  };
      ...
      >
        ...
        <Box display="flex" gap={1}>
          ...
          <Button
            ...
            color="primary"
            component={Link}
            href="/apps/stores/create"
          >
            New store
          </Button>
        </Box>
      </Stack>
      <Box sx={{ overflowX: "auto", paddingTop: '8px' }}>
        <BlankCard>
          <TableContainer>
                ...
                {dataDisplay.map(
                  (
                    ...
                    <TableRow key={store.id}>
                      ...
                      <TableCell>
                        <Typography variant="body1" fontSize="14px">{store.email}</Typography>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell align="center">
                        ...
                        <Tooltip title="Edit">
                          ...
                          <IconButton
                            color="success"
                            component={Link}
                            href={`/apps/stores/edit/${store.id}`}
                          >
                            <IconEdit width={22} />
                          </IconButton>
                        </Tooltip>
