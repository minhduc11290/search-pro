...
export const AdminContext = createContext<AdminContextType | any>(undefined);
...
export const AdminProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <AdminContext.Provider value={{ data, loading, error, deleteInvoice, addInvoice, updateInvoice, fetchData }}>
            {children}
