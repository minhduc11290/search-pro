...
interface LocationCreateContextType {
...
export const LocationCreateContext = createContext<LocationCreateContextType | any>(undefined);

export const LocationCreateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <LocationCreateContext.Provider value={{ invoices, loading, error, deleteInvoice, addInvoice, updateInvoice }}>
            {children}
