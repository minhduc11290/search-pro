...
export const ProductCreateContext = createContext<ProductCreateContextType | any>(undefined);

export const ProductCreateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <ProductCreateContext.Provider value={{ invoices, loading, error, deleteInvoice, addInvoice, updateInvoice }}>
            {children}
